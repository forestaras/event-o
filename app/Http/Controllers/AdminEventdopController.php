<?php namespace App\Http\Controllers;
	...
	class AdminEventdopController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Назва посилання','name'=>'titlesilka','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Eventid','name'=>'eventid','value'=>$_GET['event'],'type'=>"hidden",'width'=>'col-sm-10','datatable'=>'event,id'];
			$this->form[] = ['label'=>'url (адреса)','name'=>'text','type'=>'text','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
