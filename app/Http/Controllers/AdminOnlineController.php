<?php namespace App\Http\Controllers;
	...
	class AdminOnlineController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Стартові','name'=>'starovi','type'=>'checkbox','validation'=>'min:1|max:255','width'=>'col-sm-10','dataenum'=>'✓'];
			$this->form[] = ['label'=>'Результати','name'=>'rezult','type'=>'checkbox','validation'=>'min:1|max:255','width'=>'col-sm-10','dataenum'=>'✓'];
			$this->form[] = ['label'=>'Формула нарахування балів','name'=>'rezult_formula_ball','type'=>'text','validation'=>'max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Спліти','name'=>'split','type'=>'checkbox','validation'=>'min:1|max:255','width'=>'col-sm-10','dataenum'=>'✓'];
			$this->form[] = ['label'=>'Графік сплітів','name'=>'split_grafic','type'=>'checkbox','validation'=>'min:1|max:255','width'=>'col-sm-9','dataenum'=>'✓'];
			$this->form[] = ['label'=>'Командні результати','name'=>'comandni','type'=>'checkbox','validation'=>'min:1|max:255','width'=>'col-sm-10','dataenum'=>'✓'];
			$this->form[] = ['label'=>'Стартовий годинник','name'=>'startclok','type'=>'checkbox','validation'=>'min:1|max:255','width'=>'col-sm-9','dataenum'=>'✓'];
			...
			//$this->form[] = ['label'=>'Результати','name'=>'rezult','type'=>'checkbox','validation'=>'min:1|max:255','width'=>'col-sm-10','dataenum'=>'✓'];
			//$this->form[] = ['label'=>'Формула нарахування балів','name'=>'rezult_formula_ball','type'=>'text','validation'=>'max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Спліти','name'=>'split','type'=>'checkbox','validation'=>'min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Графік сплітів','name'=>'split_grafic','type'=>'checkbox','validation'=>'min:1|max:255','width'=>'col-sm-9'];
			//$this->form[] = ['label'=>'Командні результати','name'=>'comandni','type'=>'checkbox','validation'=>'min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Стартовий годинник','name'=>'startclok','type'=>'checkbox','validation'=>'min:1|max:255','width'=>'col-sm-9'];
			# OLD END FORM
