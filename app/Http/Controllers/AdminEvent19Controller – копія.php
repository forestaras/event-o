<?php namespace App\Http\Controllers;
	...
	class AdminEvent19Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Створено","name"=>"userid"];
			...
			$this->form[] = ['label'=>'Область','name'=>'oblid','type'=>'select2','validation'=>'required|integer','width'=>'col-sm-10','datatable'=>'obl,title'];
	    ...
	    */
	    public function hook_query_index(&$query) {
            $query->where('event.userid',CRUDBooster::myId());
         }
